...
input_field = tk.Entry(input_frame, font=('arial', 18, 'bold'), textvariable=input_text, width=50, bg="#eee",
...
LEFT_BRACKET = tk.Button(btns_frame, text="(", fg="black", width=10, height=3, bd=0, bg="#eee",
                         cursor="hand2", command=lambda: bt_click('(')).grid(row=0, column=1, padx=1, pady=1)
...
SEVEN = tk.Button(btns_frame, text="7", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
                  command=lambda: bt_click(7)).grid(row=1, column=0, padx=1, pady=1)
EIGHT = tk.Button(btns_frame, text="8", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
                  command=lambda: bt_click(8)).grid(row=1, column=1, padx=1, pady=1)
NINE = tk.Button(btns_frame, text="9", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
                 command=lambda: bt_click(9)).grid(row=1, column=2, padx=1, pady=1)
MULTIPLY = tk.Button(btns_frame, text="*", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand2",
                     command=lambda: bt_click("*")).grid(row=1, column=3, padx=1, pady=1)
FOUR = tk.Button(btns_frame, text="4", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
                 command=lambda: bt_click(4)).grid(row=2, column=0, padx=1, pady=1)
FIVE = tk.Button(btns_frame, text="5", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
                 command=lambda: bt_click(5)).grid(row=2, column=1, padx=1, pady=1)
SIX = tk.Button(btns_frame, text="6", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
                command=lambda: bt_click(6)).grid(row=2, column=2, padx=1, pady=1)
MINUS = tk.Button(btns_frame, text="-", fg="black", width=10,height=3, bd=0, bg="#eee", cursor="hand2",
                  command=lambda: bt_click("-")).grid(row=2, column=3, padx=1, pady=1)
ONE = tk.Button(btns_frame, text="1", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
                command=lambda: bt_click(1)).grid(row=3, column=0, padx=1, pady=1)
TWO = tk.Button(btns_frame, text="2", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
                command=lambda: bt_click(2)).grid(row=3, column=1, padx=1, pady=1)
THREE = tk.Button(btns_frame, text="3", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
                  command=lambda: bt_click(3)).grid(row=3, column=2, padx=1, pady=1)
PLUS = tk.Button(btns_frame, text="+", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand2",
                 command=lambda: bt_click("+")).grid(row=3, column=3, padx=1, pady=1)
ZERO = tk.Button(btns_frame, text="0", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
...
POINT = tk.Button(btns_frame, text=".", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand2",
                  command=lambda: bt_click(".")).grid(row=4, column=2, padx=1, pady=1)
EQUALS = tk.Button(btns_frame, text="=", fg="black", width=10, height=3, bd=0, bg="#eee", cursor="hand2",
